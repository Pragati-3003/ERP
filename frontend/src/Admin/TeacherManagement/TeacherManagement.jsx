...
const TeacherManagement = () => {
    ...
    return (
        <div className="flex flex-col items-center py-12">
            ...
            {/* Forms */}
            <form className="shadow-sm rounded-lg border border-gray-300 p-8 w-full max-w-2xl" onSubmit={handleSubmit}>
                {activeTab === "add" && (
                    <>
                        <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Add Teacher</h2>
                        ...
                        <button type="submit" className="w-full mt-8 py-3 px-6 text-white font-semibold rounded-md bg-blue-600 hover:bg-blue-700 transition duration-300">
                            Add Teacher
                        </button>
                    </>
                )}
                ...
                {activeTab === "update" && (
                    <>
                        <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Update Teacher</h2>
                        <div className="mb-4">
                        ...
                        <button type="button" onClick={handleSearch} className="w-full mb-6 py-3 px-6 text-white font-semibold rounded-md bg-green-500 hover:bg-green-600 transition duration-300">
                            Search Teacher
                        </button>
                        {searchResult && (
                            <>
                                ...
                                <button type="submit" className="w-full mt-8 py-3 px-6 text-white font-semibold rounded-md bg-yellow-500 hover:bg-yellow-600 transition duration-300">
                                    Update Teacher
                                </button>
                            </>
                        )}
                ...
                {activeTab === "delete" && (
                    <>
                        <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Delete Teacher</h2>
                        <input
                            type="text"
                        ...
                        />
                        <button type="submit" className="w-full py-3 px-6 text-white font-semibold rounded-md bg-red-500 hover:bg-red-600 transition duration-300">
                            Delete Teacher
                        </button>
                    </>
                )}
