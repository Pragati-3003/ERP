    ...
    return (
        <div className="flex flex-col items-center py-12">
            ...
            >
                ...
                {activeTab === "update" && (
                    <>
                        <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Update Course</h2>
                        <div className="mb-4">
                            <label htmlFor="CourseCode" className="block text-sm font-medium text-gray-400 mb-1">
