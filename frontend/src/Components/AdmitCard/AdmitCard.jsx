...
const AdmitCard = () => {
  return (
    <div className="max-w-4xl mx-auto border-4 border-gray-800 p-8 shadow-lg bg-gray-100">
      {/* Header section */}
      <div className="text-center mb-8">

        <h1 className="text-3xl font-bold uppercase text-[#00008b]">BANASTHALI VIDYAPITH</h1>
        <h2 className="text-xl font-semibold mt-2 text-[#00008b]">ADMIT CARD</h2>
      ...
      <div className="grid grid-cols-3 gap-8 items-start">
        <div className="col-span-2 space-y-2">
          ...
          <p><strong>Enrolment No. :</strong> 2021/2790</p>
        ...
        <div className="text-center">
          ...
          />
          <div className="mt-6">Candidate's Signature</div>
        </div>
      </div>

      {/* Details of Theory Papers */}
      <div className="mt-8">
        <h3 className="text-lg font-semibold underline text-[#00008b]">Details of Theory Papers :-</h3>
        <ul className="mt-2 space-y-1">
          ...
          <li>TSKL 401 - Communication Skills</li>
        </ul>
      </div>

      {/* Instructions */}
      <div className="mt-8 border-t border-gray-800 pt-4">
        <h3 className="text-lg font-semibold underline mb-2 text-[#00008b]">INSTRUCTIONS</h3>
