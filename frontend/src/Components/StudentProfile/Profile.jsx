  ...
  return (
    <div className="grid grid-cols-2 gap-6">
      ...
      <div className="bg-gray-100 p-4 rounded-md">
        ...
        <p>
          <strong>Smart ID:</strong> {userInfo.smartID}
        </p>
        <p>
          <strong>Gender:</strong> {userInfo.Gender}
        </p>
        <p>
          <strong>DOB:</strong> {new Date(userInfo.DOB).toLocaleDateString()}
        </p>
      </div>
      ...
      <div className="bg-gray-100 p-4 rounded-md">
        ...
        <p>
          <strong>Scholarship:</strong> {userInfo.Scholarship || "N/A"}
        </p>
        <p>
          <strong>Attendance Status:</strong>{" "}
          {userInfo.AttendanceStatus || "N/A"}
        </p>
        <p>
          <strong>Hostel Name:</strong> {userInfo.HostelName || "N/A"}
        </p>
      </div>
      ...
      <div className="col-span-2 bg-blue-100 p-4 rounded-md">
        ...
        <p>
          <strong>Guardian Email:</strong> {userInfo.GuardianEmail}
        </p>
      </div>
    </div>
  );
